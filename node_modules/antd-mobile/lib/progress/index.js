...
var Progress = function (_React$Component) {
    ...
    (0, _createClass3['default'])(Progress, [{
        ...
        value: function render() {
            ...
            var child = _react2['default'].createElement(_reactNative.View, { style: [styles.progressBar, style, percentStyle] });
            if (this.props.appearTransition) {
                percentStyle.width = this.state.percentage;
                child = _react2['default'].createElement(_reactNative.Animated.View, { style: [styles.progressBar, style, percentStyle] });
            }
            var outerStyle = [styles.progressOuter, position === 'fixed' ? { position: 'absolute', top: 0 } : null, unfilled === 'hide' ? { backgroundColor: 'transparent' } : null];
