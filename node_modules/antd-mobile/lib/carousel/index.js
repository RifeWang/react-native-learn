...
var defaultPagination = function defaultPagination(props) {
    ...
    return _react2['default'].createElement(_pagination2['default'], { style: [styles.pagination, styles[positionStyle]], indicatorStyle: { flexDirection: flexDirection }, current: current, mode: 'pointer', total: count });
};
    ...
    function Carousel(props) {
        ...
        _this.renderContent = function (pages) {
            ...
            return _react2['default'].createElement(
                ...
                (0, _extends3['default'])({ ref: 'scrollview' }, _this.props, { horizontal: true, pagingEnabled: true, bounces: !!_this.props.bounces, scrollEventThrottle: 100, removeClippedSubviews: false, automaticallyAdjustContentInsets: false, directionalLockEnabled: true, showsHorizontalScrollIndicator: false, showsVerticalScrollIndicator: false, contentContainerStyle: _this.props.style, contentOffset: _this.state.offset }, others),
                pages
            );
        };
