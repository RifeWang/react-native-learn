...
var Button = function (_React$Component) {
    ...
    (0, _createClass3['default'])(Button, [{
        ...
        value: function render() {
            ...
            ['activeOpacity', 'delayPressOut', 'underlayColor', 'onPress', 'onPressIn', 'onPressOut', 'onShowUnderlay', 'onHideUnderlay'].forEach(function (prop) {
            ...
            var underlayColor = _reactNative.StyleSheet.flatten(buttonStyles[activeStyle ? type + 'Highlight' : type + 'Raw']).backgroundColor;
            var indicatorColor = _reactNative.StyleSheet.flatten(this.state.pressIn ? buttonStyles[type + 'HighlightText'] : buttonStyles[type + 'RawText']).color;
            return _react2['default'].createElement(
                _reactNative.TouchableHighlight,
                (0, _extends3['default'])({ activeOpacity: 1, delayPressOut: 1, underlayColor: underlayColor, style: wrapperStyle, onPress: function onPress(e) {
                ...
                _react2['default'].createElement(
                    ...
                    loading ? _react2['default'].createElement(_reactNative.ActivityIndicator, { style: buttonStyles.indicator, animating: true, color: indicatorColor, size: 'small' }) : null,
                    _react2['default'].createElement(
                        _reactNative.Text,
                        { style: textStyle },
                        this.props.children
