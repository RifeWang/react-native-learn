...
var Progress = function (_React$Component) {
    ...
    _createClass(Progress, [{
        ...
        value: function render() {
            ...
            var child = React.createElement(View, { style: [styles.progressBar, style, percentStyle] });
            if (this.props.appearTransition) {
                percentStyle.width = this.state.percentage;
                child = React.createElement(Animated.View, { style: [styles.progressBar, style, percentStyle] });
            }
