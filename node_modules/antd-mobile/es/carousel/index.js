...
var defaultPagination = function defaultPagination(props) {
    ...
    return React.createElement(Pagination, { style: [styles.pagination, styles[positionStyle]], indicatorStyle: { flexDirection: flexDirection }, current: current, mode: 'pointer', total: count });
};
    ...
    function Carousel(props) {
        ...
        _this.renderContent = function (pages) {
            ...
            return React.createElement(
                ScrollView,
                _extends({ ref: 'scrollview' }, _this.props, { horizontal: true, pagingEnabled: true, bounces: !!_this.props.bounces, scrollEventThrottle: 100, removeClippedSubviews: false, automaticallyAdjustContentInsets: false, directionalLockEnabled: true, showsHorizontalScrollIndicator: false, showsVerticalScrollIndicator: false, contentContainerStyle: _this.props.style, contentOffset: _this.state.offset }, others),
                pages
            );
        };
