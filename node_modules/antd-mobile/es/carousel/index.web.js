...
var Carousel = function (_React$Component) {
    ...
    _createClass(Carousel, [{
        ...
        value: function render() {
            ...
            var wrapCls = classNames((_classNames2 = {}, _defineProperty(_classNames2, className, className), _defineProperty(_classNames2, prefixCls, true), _defineProperty(_classNames2, prefixCls + '-vertical', props.vertical), _classNames2));
            return React.createElement(ReactCarousel, _extends({}, props, { className: wrapCls, decorators: Decorators, afterSlide: this.onChange }));
        }
    }]);
